...
@Entity(name = DatabaseName.CARD_LAYOUT.TABLE)
@Table(name = DatabaseName.CARD_LAYOUT.TABLE)
public class CardLayout implements Serializable, CodeObject {
	...
	@Column(name=DatabaseName.CARD_LAYOUT.CODE)
	private String code;

	@Column(name=DatabaseName.CARD_LAYOUT.NAME)
	private String name;
