...
@Entity(name = DatabaseName.CARD_COLOR.TABLE)
@Table(name = DatabaseName.CARD_COLOR.TABLE)
public class CardColor implements Serializable, CodeObject {
	...
	@Column(name=DatabaseName.CARD_COLOR.CODE)
	private String code;

	@Column(name=DatabaseName.CARD_COLOR.NAME)
	private String name;
