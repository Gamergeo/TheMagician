...
@Entity(name = DatabaseName.CARD_TYPE.TABLE)
@Table(name = DatabaseName.CARD_TYPE.TABLE)
public class CardType implements Serializable, CodeObject {
	...
	@Column(name=DatabaseName.CARD_TYPE.CODE)
	private String code;

	@Column(name=DatabaseName.CARD_TYPE.NAME)
	private String name;
